...
{ 
    var gas=crypto.pbkdf2Sync(input, salt, 100000, 512, 'sha512');
    return ["pbdkdf","10000",salt,hashed.toString('hex')].join('$');
    
}
app.get('/hash/:name',function(req,res)
{
   var hashedstring=hash(req.params.name,"this is a salt value");
